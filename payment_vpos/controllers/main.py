...
class OgoneController(http.Controller):
    ...
    _cancel_url = '/payment/vpos/test/cancel'

    @http.route([
        '/payment/vpos/accept', '/payment/vpos/test/accept',
        '/payment/vpos/decline', '/payment/vpos/test/decline',
    ...
    def ogone_s2s_create_json_3ds(self, verify_validity=False, **kwargs):
        ...
        if verify_validity != False:
            ...
            params = {
                'accept_url': baseurl + '/payment/vpos/validate/accept',
                'decline_url': baseurl + '/payment/vpos/validate/decline',
                'exception_url': baseurl + '/payment/vpos/validate/exception',
